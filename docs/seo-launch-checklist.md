...
- MinistryPlatform user-login widget passed a live whitelist test on the GitHub Pages review origin on July 22, 2026. The public Events page and hidden Event Details and Event Checkout utility pages are published. Giving, event, update, prayer, and support widgets still require their exact approved embed snippets or configuration identifiers before implementation.
